...
CREATE TABLE RECORRIDO.ESTATUS_VIAJE(
    ...
    CONSTRAINT PK_ESTATUS_VIAJE PRIMARY KEY CLUSTERED (ID_VIAJE ASC, CLAVE_ESTATUS ASC)
);
go
...
CREATE UNIQUE NONCLUSTERED  INDEX UI_NOMBRE_USUARIO ON PERSONA.USUARIO(NOMBRE_USUARIO);
